...
export default function CategoryCreatePage() {
  ...
  const existing = React.useMemo(() => {
    ...
    try {
      const cats = JSON.parse(localStorage.getItem(STORAGE_KEY) || JSON.stringify([{ id: 'descriptions', label: 'Beschreibungen', icon: 'ScrollText', color: '#3b82f6', description: 'Dienstvorschriften, Beschreibungen und Regelwerke' }, { id: 'templates', label: 'Vorlagen', icon: 'FileText', color: '#8b5cf6', description: 'Formulare, Vorlagen und Musterdokumente' }, { id: 'training', label: 'Schulungsunterlagen', icon: 'GraduationCap', color: '#10b981', description: 'Ausbildungsunterlagen und Lernmaterial' }]));
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 pb-8">
          <button onClick={() => navigate('/documents')} className="btn-secondary flex-1">Abbrechen</button>
